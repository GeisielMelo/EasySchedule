...
################################################################################
## Form generated from reading UI file 'ui_mainNDHnYF.ui'
##
...
"")
        ...
        self.clientsTable.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContents)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.homeBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Inicio", None))
#endif // QT_CONFIG(tooltip)
        self.homeBtn.setText("")
#if QT_CONFIG(tooltip)
        self.clientsBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Clientes", None))
#endif // QT_CONFIG(tooltip)
        self.clientsBtn.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
#if QT_CONFIG(tooltip)
        self.appointmentBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Agendamentos", None))
#endif // QT_CONFIG(tooltip)
        self.appointmentBtn.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
#if QT_CONFIG(tooltip)
        self.logoutBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Sair", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.lineBornDateEdit.setDisplayFormat(QCoreApplication.translate("MainWindow", u"d/M/yyyy", None))
...
#if QT_CONFIG(tooltip)
        self.appointmentConfirmBtn.setToolTip(QCoreApplication.translate("MainWindow", u"CONFIRMAR AGENDAMENTO", None))
#endif // QT_CONFIG(tooltip)
        self.appointmentConfirmBtn.setText("")
#if QT_CONFIG(tooltip)
        self.appointmentCancelBtn.setToolTip(QCoreApplication.translate("MainWindow", u"CANCELAR AGENDAMENTO", None))
#endif // QT_CONFIG(tooltip)
        self.appointmentCancelBtn.setText("")
#if QT_CONFIG(tooltip)
        self.addBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Adicionar", None))
#endif // QT_CONFIG(tooltip)
        self.addBtn.setText("")
#if QT_CONFIG(tooltip)
        self.delBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Deletar", None))
#endif // QT_CONFIG(tooltip)
        self.delBtn.setText("")
#if QT_CONFIG(tooltip)
        self.editBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Editar", None))
#endif // QT_CONFIG(tooltip)
        self.editBtn.setText("")
#if QT_CONFIG(tooltip)
        self.scheduleBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Marcar | Remarcar | Cancelar", None))
#endif // QT_CONFIG(tooltip)
        self.scheduleBtn.setText("")
#if QT_CONFIG(tooltip)
        self.reloadBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Atualizar", None))
#endif // QT_CONFIG(tooltip)
